...
export const FIELD_BASE_CLS =
  `rounded-lg border border-neutral-200 bg-white text-sm text-foreground transition-[border-color,box-shadow] duration-200 placeholder:text-neutral-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60 dark:border-neutral-600 dark:bg-neutral-800/60 dark:placeholder:text-neutral-500 ${FIELD_FOCUS_CLS}`;
